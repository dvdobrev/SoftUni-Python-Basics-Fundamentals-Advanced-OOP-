...
class YoungCoupleWithChildren(Room):
    ...
    def __init__(self, family_name: str, salaray_one: float, salaray_two: float, *children):
    ...
    def get_appliances(self):
        list_appliances = []
        for i in range(self.members_count + len(self.children)):
...
#
# a = YoungCoupleWithChildren("Dobrev", 200, 200, [])
# print(a.expenses)
