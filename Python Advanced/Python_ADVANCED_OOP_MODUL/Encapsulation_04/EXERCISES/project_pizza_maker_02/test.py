...
from Python_ADVANCED_OOP_MODUL.Encapsulation_04.EXERCISES.project_pizza_maker_02.pizza import Pizza
from Python_ADVANCED_OOP_MODUL.Encapsulation_04.EXERCISES.project_pizza_maker_02.topping import Topping
